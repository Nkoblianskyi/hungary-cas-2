...
export function Hero() {
  ...
  return (
    <section
      className="relative bg-cover bg-center bg-no-repeat py-6 md:py-10 lg:py-12 overflow-hidden"
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-5xl mx-auto border-2 border-red-600/30 rounded-lg p-6 md:p-8 bg-black/20">
          {/* </CHANGE> */}
          ...
          <div className="inline-flex items-center gap-2 bg-yellow-500/10 border border-yellow-500/30 rounded-full px-4 py-1.5 mb-4">
              ...
              <span className="text-xs md:text-sm text-yellow-500 font-medium tracking-wide">
                ATUALIZADO {currentMonth.toUpperCase()} {currentYear}
              </span>
            </div>

          <p className="text-sm md:text-lg lg:text-xl text-gray-300 max-w-3xl mx-auto mb-6 md:mb-8 leading-relaxed">
